...
class BookControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'book[title]' => 'First value',
            'book[pages]' => 'First value',
            'book[created]' => 'First value',
            'book[updated]' => 'First value',
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'book[title]' => 'Changed',
            'book[pages]' => 'Changed',
            'book[created]' => 'Changed',
            'book[updated]' => 'Changed',
            // ... adapt fields value here ...
        ));
        $client->submit($form);
        $crawler = $client->followRedirect();
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'book_filter[title]' => 'First%',
            'book_filter[pages]' => 'First%',
            'book_filter[created]' => 'First%',
            'book_filter[updated]' => 'First%',
